...
extension TerminalSymbolEnum {
    ...
    static let textAttributeTokens: Set<TerminalSymbolEnum> = [
...
extension TextNode {
    ...
    func isInTextAttributeTokens( _ token: TerminalSymbolEnum ) -> Bool {
        return TerminalSymbolEnum.textAttributeTokens.contains(token)
    }
    ...
    override func parseSyntaxUsingCompiler( _ compiler: RexselKernel ) throws {
        ...
        while !thisCompiler.isEndOfFile {
            ...
            switch ( thisCompiler.currentToken.type, thisCompiler.nextToken.type, thisCompiler.nextNextToken.type ) {
                ...
                case ( .terminal, _, _ ) where isInTextAttributeTokens( thisCompiler.currentToken.what )  :
