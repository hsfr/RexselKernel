...
class ApplyImportsNode: ExprNode  {
    ...
    override func parseSyntaxUsingCompiler( _ compiler: RexselKernel ) throws {
        ...
        // Slide past keyword and return. This will be expanded for later XSLT versions.
